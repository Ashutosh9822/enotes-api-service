...
public class SwaggerConfig {
	...
	public OpenAPI OpenAPI() {
		...
		info.setTermsOfService("https://thebecoder.com");
		info.setContact(new Contact().email("becoder@gmail.com").name("Sumeet Mehta").url("https://thebecoder.com/contact"));
		info.setLicense(new License().name("Enotes 1.0").url("https://thebecoder.com"));
		...
		SecurityScheme securityScheme = new SecurityScheme().type(SecurityScheme.Type.HTTP).scheme("bearer").bearerFormat("JWT").in(In.HEADER);
